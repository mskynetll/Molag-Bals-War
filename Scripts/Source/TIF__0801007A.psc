...
Scriptname TIF__0801007A Extends TopicInfo Hidden
...
AzazelInteractionsQuest.libs.removeDevice(AzazelInteractionsQuest.libs.PlayerRef, AzazelInteractionsQuest.BlindfoldWornByPlayer, AzazelInteractionsQuest.libs.GetRenderedDevice(AzazelInteractionsQuest.BlindfoldWornByPlayer), AzazelInteractionsQuest.libs.zad_DeviousHood, destroyDevice = false, skipevents = false, skipmutex = true)	
;END CODE
EndFunction
;END FRAGMENT
