Scriptname mbwPlayerKillEventDispatcherQuest extends Quest
...
Event OnStoryKillActor(ObjectReference akVictim, ObjectReference akKiller, Location akLocation, int aiCrimeStatus, \
  int aiRelationshipRank)	
	...
	EventsDispatcherQuest.PlayerKillEvent(akVictim, akKiller, akLocation, aiCrimeStatus, aiRelationshipRank)
	Stop()
endEvent